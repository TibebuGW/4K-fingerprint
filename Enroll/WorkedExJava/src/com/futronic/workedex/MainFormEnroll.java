...
import static com.futronic.workedex.postgresqlcon.addUser;
import static com.futronic.workedex.postgresqlcon.start;
 ...
 * @author  Shustikov
 */
public class MainFormEnroll extends javax.swing.JFrame implements IEnrollmentCallBack , IVerificationCallBack, IIdentificationCallBack
{
    ...
    public MainFormEnroll()
    {
        ...
        m_FingerPrintImage.setImage( createImageIcon( "image/4klabs.png" ).getImage() );
                                        ...
                                        boolean bVerificationSuccess )
    {
        ...
        if( bSuccess )
        {
            if (bVerificationSuccess)
            {
                ...
                szResult.append("Fingerprint ID ");
                String fingerprint_id = ((DbRecord)m_OperationObj).getUserName();
    ...
    private void initComponents() {
        ...
        setTitle("4k labs fingerprint attendace system");
        ...
        toptext.setText("Welcometo 4K Labs!");
        toptext.setBounds(5, 7, 410, 20);
        
        toptext2.setText( "Complete the form below to register:");
        toptext2.setBounds(5, 23, 410, 20);
        
        jLayeredPane1.add(toptext);
        jLayeredPane1.add(toptext2);
        
        jLabelName.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabelName.setText("Name: ");
        jLabelName.setBounds(20, 55, 410, 20);
        jLayeredPane1.add(jLabelName, javax.swing.JLayeredPane.DEFAULT_LAYER);
                
        txtName.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N       
        txtName.setBounds(105, 55, 250, 20);
        jLayeredPane1.add(txtName, javax.swing.JLayeredPane.DEFAULT_LAYER);
        
        jLabelFName.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabelFName.setText("Fathers Name: ");
        jLabelFName.setBounds(20, 85, 410, 20);
        jLayeredPane1.add(jLabelFName, javax.swing.JLayeredPane.DEFAULT_LAYER);
                
        txtFName.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N       
        txtFName.setBounds(105, 85, 250, 20);
        jLayeredPane1.add(txtFName, javax.swing.JLayeredPane.DEFAULT_LAYER);
        
        
        jLabelDepartment.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabelDepartment.setText("Department: ");
        jLabelDepartment.setBounds(20, 115, 410, 20);
        jLayeredPane1.add(jLabelDepartment, javax.swing.JLayeredPane.DEFAULT_LAYER);
                
        txtDepartment.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N       
        txtDepartment.setBounds(105, 115, 250, 20);
        jLayeredPane1.add(txtDepartment, javax.swing.JLayeredPane.DEFAULT_LAYER);
        ...
        jLayeredPane2.setBorder(javax.swing.BorderFactory.createTitledBorder("Register Fingerprint:"));
    ...
    private void btnIdentifyActionPerformed(java.awt.event.ActionEvent evt)                                            
    {                                                
    ...
    {                                              
        ...
        {
            // Get user name
            String szUserName = JOptionPane.showInputDialog( this, "Enter fingerprint ID", "fingerprint ID", JOptionPane.PLAIN_MESSAGE );
            if( szUserName == null || szUserName.length() == 0)
            {
                JOptionPane.showMessageDialog(this,
                                          "You must enter a fingerprint ID",
                                          getTitle(), JOptionPane.WARNING_MESSAGE );
                return;
            }
            ...
            if( isUserExists( szUserName ) )
            {
                 Object[] options = {"OK"};
                   ...
                   "The ID already exists. Please enter a different ID","Fingerprint ID Error",
...
//                int nResponse;
//                nResponse = JOptionPane.showConfirmDialog( this,
//                                                           "The ID already exists. Do you want replace it?",
//                                                           getTitle(), 
...
//                    return;
                ...
                postgresqlcon.start();
                user.f_id = szUserName;
                user.name = txtName.getText().toString();
                user.fathers_name = txtFName.getText().toString();
                user.department = txtDepartment.getText().toString();
                
                postgresqlcon.addUser(user);
    ...
    private void cbFARNLevelItemStateChanged(java.awt.event.ItemEvent evt)                                             
    {                                                 
    ...
    public static void main(String args[])
    {
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                ...
                new MainFormEnroll().setVisible(true);
            }
        });
    }
    ...
    {
        java.net.URL imgURL = MainFormEnroll.class.getResource(path);
        if (imgURL != null) {
