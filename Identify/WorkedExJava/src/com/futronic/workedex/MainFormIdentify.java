 ...
 * @author  Shustikov
 */
public class MainFormIdentify extends javax.swing.JFrame 
        implements IEnrollmentCallBack , IVerificationCallBack, IIdentificationCallBack
{
        ...
        if (bSuccess)
        {
            ...
            if (nResult == FutronicSdkBase.RETCODE_OK)
            {
                ...
                if( result.m_Index != -1 ){
                    ...
                    String name = Users.get( result.m_Index ).getUserName();
                    postgresqlcon p = new postgresqlcon();
                    p.start(name);
                    System.out.println(Users.get( result.m_Index ).getUserName());
                }
    ...
    private void initComponents() {
        ...
        toptext.setText("WELCOME TO 4K LABS.");
        toptext2.setText( " PLEASE CLICK ON IDENTIFY TO REGISTER ATTENDANCE");
        toptext.setBounds(50, 70, 410, 20);
        
        toptext2.setBounds(50, 100, 410, 20);
        ...
        btnIdentify.setBounds(20, 30, 90, 23);
    ...
    public static void main(String args[])
    {
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                ...
                new MainFormIdentify().setVisible(true);
            }
        });
    }
    ...
    {
        java.net.URL imgURL = MainFormIdentify.class.getResource(path);
        if (imgURL != null) {
